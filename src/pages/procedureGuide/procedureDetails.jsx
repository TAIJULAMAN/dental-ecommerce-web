...
export default function ProcedureDetails() {
    ...
    const products = [
        ...
        { id: '2', name: 'Walden Tesla Air Rotor', image: '/image1.png' },
        { id: '3', name: 'Walden Tesla Air Rotor', image: '/image2.png' },
        { id: '4', name: 'Walden Tesla Air Rotor', image: '/image3.png' },
        { id: '5', name: 'Walden Tesla Air Rotor', image: '/image.png' },
        { id: '6', name: 'Walden Tesla Air Rotor', image: '/image1.png' },
        { id: '7', name: 'Walden Tesla Air Rotor', image: '/image2.png' },
        { id: '8', name: 'Walden Tesla Air Rotor', image: '/image3.png' },
    ];
    ...
    return (
        <div className="min-h-screen">
            <div className="container mx-auto px-4 py-10">
                ...
                <div className="mt-10">
                    <h1 className="text-2xl font-bold text-white">Root Canal Treatment</h1>
                ...
                <div className="flex justify-between items-center mt-10">
                    ...
                    <label className="flex items-center space-x-3 cursor-pointer group">
                        ...
                        <div className="relative">
                            ...
                            />
                            <div className={`w-5 h-5 rounded border-2 border-[#136BFB] bg-black  transition-all duration-200 ${selectAll
                                ? 'border-[#136BFB]'
                                : ''
                                }`}>
                                {selectAll && (
